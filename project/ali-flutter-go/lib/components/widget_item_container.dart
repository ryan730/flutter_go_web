              ...
              child: WidgetItem(
                ...
                onTap: () {
                  if (isWidgetPoint) {
                    ...
                    print('=======isWidgetPoint========>${widgetDemosList}');
                    ...
                    ////Navigator.pushNamed(context, '$targetRouter', arguments: { "id": 1} );
                    print('===============1>${targetRouter}');
                  } else {
                    Application.router.navigateTo(context, "/category/${item.name}", transition: TransitionType.inFromRight);
                    ///Navigator.pushNamed(context, '/category/${item.name}', arguments: { "id": 1} );
                    print('===============2>/category/${item.name}');
                  }
                },
                index: addI,
                totalCount: length,
